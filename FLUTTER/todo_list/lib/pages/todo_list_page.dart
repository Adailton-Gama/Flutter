...
class _TodoListPageState extends State<TodoListPage> {
  ...
  void addTask() {
    ...
    if (getTask == '') {
      ...
      ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text('Favor preencher a tarefa',textAlign: TextAlign.center,),backgroundColor: Color.fromRGBO(0x12, 0xCB, 0xE0, 1),));
    } else {
  ...
  void addTaskSubmited(String getTask){
    ...
    if (getTask == '') {
      ...
      print('Tarefa $getTask adicionada!');
      setState(() {
        Todo newTodo = Todo(title: task.text, dataTime: DateTime.now(),complete: false);
        todos.add(newTodo);
        count = todos.length;
        print('indice: $count, da tarefa: $getTask');
        todoRepository.saveTodoList(todos);
                    ...
                    if(editText.text == ''){
                      ...
                      ScaffoldMessenger.of(context).showSnackBar(
                        const SnackBar(
                          ...
                          content: Text('Favor preencher a tarefa que deseja alterar!'),
